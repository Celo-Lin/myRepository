...
public class PublicRSA {
    ...
    public static void main(String[] args) throws Exception {
        ...
        KeyPair keyPair = PublicRSA.getKeyPair();
        //公钥
        String publicKey = PublicRSA.getPublicKey(keyPair);
        //私钥
        String privateKey = PublicRSA.getPrivateKey(keyPair);
        ...
        {
            System.out.println("\n===========私钥加密，公钥解密==============");
            String s1 = PublicRSA.encryptByPrivateKey(data, privateKey);
            System.out.println("加密后的数据:" + s1);
            String s2 = PublicRSA.decryptByPublicKey(s1, publicKey);
            System.out.println("解密后的数据:" + s2 + "\n\n");
        }
 
        {
            System.out.println("\n===========公钥加密，私钥解密==============");
            String s1 = PublicRSA.encryptByPublicKey(data, publicKey);
            System.out.println("加密后的数据:" + s1);
            String s2 = PublicRSA.decryptByPrivateKey(s1, privateKey);
            System.out.println("解密后的数据:" + s2 + "\n\n");
        }
