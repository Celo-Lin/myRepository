...
public class DataSourceConfiguration {
	...
	@Autowired
	private BidRecordDatabase bidRecordDatabase;
    ...
    @Bean(name = "bidRecordDataSource")
    public DataSource bidRecordDataSource() {
    	DruidDataSource dataSource = DruidDataSourceBuilder.create().build();
    	dataSource.setDriverClassName(driverClass);
    	dataSource.setUrl(bidRecordDatabase.getJdbcUrl());
    	dataSource.setUsername(bidRecordDatabase.getUserName());
    	dataSource.setPassword(bidRecordDatabase.getPassword());
    	initDruidConfig(dataSource);
    	return dataSource;
    }
