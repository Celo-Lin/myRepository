...
public final class ModuloPreciseTableShardingAlgorithm implements PreciseShardingAlgorithm<Long> {
    ...
    public String doSharding(Collection<String> availableTargetNames, PreciseShardingValue<Long> shardingValue) {
        ...
        String errorMsg = String.format("ModuloPreciseTableShardingAlgorithm error:logicTableName:%s| shardingValue:%d", shardingValue.getLogicTableName(), shardingValue.getValue());
